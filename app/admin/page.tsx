      ...
      value:
        categories.length > 0
          ? categories.reduce((prev, current) =>
              getProductCountForCategory(prev.id) >
              getProductCountForCategory(current.id)
                ? prev
                : current
            ).name
          : "None",
    ...
    <div className="space-y-6">
      <div>
        ...
        <p className="text-gray-600 mt-1">
          Quick stats and navigation to manage your store
        </p>
      </div>
                  ...
                  >
                    <div>
                      ...
                      <p className="text-sm text-gray-500">
                        ...
                        {getProductCountForCategory(category.id) !== 1
                          ? "s"
                          : ""}
                      </p>
                    </div>
